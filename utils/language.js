...
const STRINGS = {
  es: {
    ...
    miniappTitle: (miniapp, squad) => `🧩 *¿Es sobre la Mini-App ${miniapp}?* _(${squad})_`,
    miniappTechnical: (emName) => `• Algo técnico → hablar con *${emName}* _(Engineering Manager)_`,
    miniappProduct: (pmName) => `• Algo de producto → hablar con *${pmName}* _(Product Manager)_`,
  ...
  en: {
    ...
    miniappTitle: (miniapp, squad) => `🧩 *Is this about the ${miniapp} Mini-App?* _(${squad})_`,
    miniappTechnical: (emName) => `• Technical issue → talk to *${emName}* _(Engineering Manager)_`,
    miniappProduct: (pmName) => `• Product/UX → talk to *${pmName}* _(Product Manager)_`,
