...
const STRINGS = {
  es: {
    iKnow: (q) => `🤓☝🏻 Buscando a los mejores expertos para: _${q}_ :hu-knows:`,
    ...
    topExpertsHeader: (q) => `🏆 Mejores coincidencias para este tema: _${q}_`,
    singleExpertHeader: (q) => `I know! Te sugiero que hables con alguien sobre: _${q}_`,
  ...
  en: {
    iKnow: (q) => `🤓☝🏻 Looking for who knows about: _${q}_ :hu-knows:`,
    ...
    topExpertsHeader: (q) => `🏆 Best matches for this topic: _${q}_`,
    singleExpertHeader: (q) => `I know! I suggest you talk to someone about: _${q}_`,
