...
const STRINGS = {
  es: {
    ...
    resultIntro: "🤓☝🏻 Ya sé! Te sugiero que hables con:",
    topExpertsHeader: (q) => `🏆 Mejores coincidencias para este tema: ${q}`,
    singleExpertHeader: (q) => `🏆 Tema: ${q}`,
  ...
  en: {
    ...
    resultIntro: "🤓☝🏻 I know! I suggest you talk to:",
    topExpertsHeader: (q) => `🏆 Best matches for this topic: ${q}`,
    singleExpertHeader: (q) => `🏆 Topic: ${q}`,
