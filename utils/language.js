...
const STRINGS = {
  es: {
    iKnow: (q) => `:hu-knows: Buscando a los mejores expertos para: _${q}_`,
    ...
    resultIntro: "🤓☝🏻 ¡Ya sé! Encontré lo siguiente:",
  ...
  en: {
    iKnow: (q) => `:hu-knows: Looking for the best experts for: _${q}_`,
    ...
    resultIntro: "🤓☝🏻 I know! Here's what I found:",
